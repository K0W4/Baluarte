...
struct CommitteeDetailViewModelTests {
    ...
    func testInitialization() {
        let viewModel = CommitteeDetailViewModel(committee: sampleCommittee)
    ...
    func testSaveChangesSuccess() async {
        ...
        let viewModel = CommitteeDetailViewModel(committee: sampleCommittee, committeeService: mockService)
