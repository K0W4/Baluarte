...
struct EventDetailViewModelTests {
    ...
    func testInitialization() {
        let viewModel = EventDetailViewModel(event: sampleEvent, currentMembershipId: UUID())
    ...
    func testSaveChangesSuccess() async {
        ...
        let viewModel = EventDetailViewModel(event: sampleEvent, currentMembershipId: UUID(), eventService: mockService)
    ...
    func testToggleAttendanceConfirm() async {
        let mockService = TestMockEventService()
        let userId = UUID()
        let viewModel = EventDetailViewModel(event: sampleEvent, currentMembershipId: userId, eventService: mockService)
    ...
    func testToggleAttendanceRemove() async {
        ...
        let viewModel = EventDetailViewModel(event: event, currentMembershipId: userId, eventService: mockService)
