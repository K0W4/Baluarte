...
public extension Goal {
    static var skeletonList: [Goal] {
        [
            Goal(id: SkeletonIds.goal1, chapterId: SkeletonIds.chapter, type: "memberCount", title: "Meta Exemplo Longa", description: "Carregando...", currentValue: 50, targetValue: 100, targetDate: Date(), createdAt: Date()),
            Goal(id: SkeletonIds.goal2, chapterId: SkeletonIds.chapter, type: "financial", title: "Segunda Meta", description: "Carregando...", currentValue: 30, targetValue: 100, targetDate: Date(), createdAt: Date()),
            Goal(id: SkeletonIds.goal3, chapterId: SkeletonIds.chapter, type: "engagement", title: "Terceira Meta", description: "Carregando...", currentValue: 70, targetValue: 100, targetDate: Date(), createdAt: Date())
        ]
    }
}
